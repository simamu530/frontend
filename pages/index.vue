    ...
    <v-app id="apexTable">
      <v-container>
        <v-row class="avgarea">
          <v-col>
            <p>
              このサイトは全世界のプロゲーマーの設定をデータベース化したものです。<br />
                  ...
                  <v-dialog v-model="dialog" max-width="500px">
                    ...
                    <v-card>
                      ...
                      <v-card-actions>
                        ...
                        <v-btn text @click="addItem()" v-if="editedIndex == -1">
                          追加
                        </v-btn>
                        <v-btn text @click="save" v-else> 更新 </v-btn>
                      </v-card-actions>
                    </v-card>
                  </v-dialog>
...
export default {
  ...
  methods: {
    async test() {
      ...
      await this.$axios
        .post(
          "https://protected-refuge-26791.herokuapp.com/api/v1/apexprolist",
          sendData
        )
        .then((res) => {
          console.log(res);
    ...
    async asyncData() {
      await this.$axios
        .get("https://protected-refuge-26791.herokuapp.com/api/v1/apexprolist")
        .then((res) => {
